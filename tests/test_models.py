...
class TestLinkIsFile:
    ...
    def test_returns_false_for_ftp_url(self) -> None:
        link = Link(
            type=LinkType.MARKDOWN_LINK,
            target="ftp://files.example.com/doc.pdf",
            alias="Doc",
    ...
    def test_returns_false_for_file_url(self) -> None:
        link = Link(
            type=LinkType.MARKDOWN_LINK,
            target="file:///path/to/file.txt",
            alias="File",
    ...
    def test_returns_false_for_mailto_url(self) -> None:
        link = Link(
            type=LinkType.PLAIN_URL,
            target="mailto:user@example.com",
            alias="Email",
    ...
    def test_returns_true_for_wikilink_target(self) -> None:
        link = Link(
            type=LinkType.WIKILINK,
            target="Note",
            alias=None,
    ...
    def test_returns_true_for_relative_path_target(self) -> None:
        link = Link(
            type=LinkType.MARKDOWN_LINK,
            target="folder/note.md",
            alias="Note",
    ...
    def test_returns_true_for_windows_style_path(self) -> None:
        link = Link(
            type=LinkType.MARKDOWN_LINK,
            target="C:\\Users\\file.txt",
            alias="File",
